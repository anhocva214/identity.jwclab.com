...
const ClientSite = (props) => {
    const dispatch = useDispatch();

    const urlBackend = useSelector(state => state.Api.urlBackend);

    const navClient = useSelector(state => state.Navigation.navClient);
                    ...
                    <div className="col-xl-2 col-lg-2 col-md-12 col-main-left active" id="col-main-left">
                        <div className="content">
                            ...
                            <ul className={"list-nav mb-0 "+displayClassActive()}>
                                <li onClick={()=>{dispatch({ type: "NAVIGATE_CLIENT", navClient: "myInfo"}); activeNav(0)}} className={"item-nav "+_nav[0]}>
                                    <span className="icon">
                                        <i className="far fa-user-circle" />
                                    </span>
                                    <span className="text">account</span>
                                </li>
                                <li onClick={()=>{dispatch({ type: "NAVIGATE_CLIENT", navClient: "about"}); activeNav(1)}} className={"item-nav "+_nav[1]}>
                                    <span className="icon">
                        ...
                        <div className="head-section">
                            ...
                            <div className="name-account text-center">
                                ...
                                <span className="text">
                                    ...
                                    <span className="badge badge-primary d-block">client</span>
                                </span>
                                <span className="icon-down">
                                    <i className="fas fa-sort-down" />
                                </span>
                                <div className="box-info">
                                    <div onClick={()=>{dispatch({ type: "NAVIGATE_CLIENT", navClient: "myInfo"}); activeNav(0)}} className="item">Thông tin</div>
