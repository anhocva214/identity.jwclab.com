...
const ClientInfo = () => {
    ...
    const setInputValue = ()=>{
        set_inputFullname(userDetail.fullname);
        set_inputEmail(userDetail.email);
        set_inputPhone(userDetail.phone);
        set_inputPosition(userDetail.position);
        set_inputAddress(userDetail.address);
        set_inputSource(userDetail.source);
            ...
            <div className="form-reset-password">
                <div className="form-group">
                    ...
                    <div className="btn-group d-flex">
                        ...
                        <input onChange={(event) => set_inputOldPassword(event.target.value)} type="password" className="form-control" placeholder="Enter New Password" />
                    </div>
                </div>
                <div className="form-group">
