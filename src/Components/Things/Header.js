        ...
        <>
            <header>
                <div className="container">
                    <div className="row">
                        <div className="col-logo col-4 col-sm-3 col-lg-2 d-flex align-items-center">
                        ...
                        <h1 className="m-0 h-100 d-flex align-items-center justify-content-center text-center">{props.title}</h1>
                        </div>
                        <div className="col-2 col-sm-2 col-lg-2 d-flex align-items-center justify-content-end">
                            <Link href="/things"><button onClick={()=>logout()} type="button" className="btn btn-danger btn-logout"><i className="fa fa-sign-out" aria-hidden="true"></i><span>Logout</span></button></Link>
                        </div>
                    </div>
                </div>
                <style jsx>{`
