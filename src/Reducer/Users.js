...
const Users = (state = initialState, action) => {
    switch (action.type) {
        ...
        case "MSG_ALERT":
            ...
            return state
        case "SORT_DATA_USERS_LIST":
            var tempData = state.dataUsersList;
        ...
        case "SET_DATA_USERS_LIST":
            return { ...state, dataUsersList: action.dataUsersList }
        case "SET_ROLE":
        ...
        case "FILTER_SOURCE":
            ...
            action.dataUsersList.map((value) => {
                if (isSourceExist(tempSource, value.source) == false) tempSource.push(value.source)
            })
